...
exports.returnsPostList = exports.postsdefinitico = void 0;
exports.postsdefinitico = [
...
function returnsPostList() {
    exports.postsdefinitico.forEach(post => {
        console.log(post);
    });
}
exports.returnsPostList = returnsPostList;
